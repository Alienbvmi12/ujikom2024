<div class="card text-start w-100" style="background: rgba(255, 255, 255, 0.9)">
    ...
    <div class="card-body">
        <h2>Kelola Diskon</h2>
        <p>Diskon akan dipilih otomatis oleh sistem berdasarkan minimum transaksi dan besarnya diskon</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="diskon" id="diskon" maxlength="3" max="100" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="minimum_transaksi" id="minimum_transaksi" />
                            </div>
                            <div class="mb-3">
